...
export const quests: Quest[] = [
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<ul>\n  \n  <li>\n<p>Allez trouver Candice à la fontaine de LH et parlez-lui (<span class=\"npc-keyword\"><span class=\"npc-keyword\"><span class=\"npc-keyword\">travail</span></span></span>). Elle vous demandera de réunir des friandises destinées à une fête pour les enfants : des fèves de cacao, du lait, des fruits et un ruban.</p>\n</li>\n  <li>\n<p>Quand vous aurez réuni ces objets, reparlez à Candice qui vous donnera un billet de tombola.</p>\n</li>\n  <li>\n<p>Ou trouver les friandises ?</p>\n</li>\n  <li>\n<p>-Fèves de cacao :</p>\n</li>\n  <li>\n<p>-Lait :</p>\n</li>\n  <li>\n<p>-Fruits :</p>\n</li>\n  <li>\n<p>-Ruban :</p>\n</li>\n  <li>\n<p></p>\n</li>\n\n</ul>",
        "images": [],
        "order": 5
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>Après avoir tué les 4 vicaires, revenez vers le portail et entrez-y. Suivez le tapis rouge et vous rencontrerez Crimsonscale le dragon. Parlez-lui et dites <span class=\"npc-keyword\">\"Lettre\"</span>, \"Commencement\", \"Elu\", \"Justice\", \"Vents\", \"Bataille des émanations\", \"Olin Haad\", \"Fasciné\", \"Changé de camp\", \"Conseil des huit\" et vous apprendrez au sujet des plans machiavéliques d’Olin Haad au sujet du <b>Conseil</b> des Huit. Crimsonscale vous demandera votre aide. Répondez <span class=\"npc-keyword\">\"Aide\"</span> puis dites <span class=\"npc-keyword\">\"Empecher\"</span>, \"Grande Librairie\" et il vous donnera le nom du <b>lieu</b> où se situe la Grande Bibliothèque. Dites <span class=\"npc-keyword\">\"Quelque chose\"</span> et il vous donnera une fiole de sang de dragon (Vial of Dragon Blood). ps: (retiré aussi)</p>\n<br/>\n<p><b>Attention</b> : Le bracelet de flammes et la gemme de flammes (Armlet of Flames et Gem of Flames) sont <b><u>supprimés</u></b> sur NMS !!</p>",
        "images": [],
        "order": 25
      },
      {
        "title": "La grande bibliothèque",
        "description": "<ul>\n  \n  <li>\n<p>Dirigez-vous vers la Grande Bibliothèque (située à l’est de l’entrée de la crypte de Raven’s Dust), allez au 3e étage et parlez avec le Conservateur (Custodian). Dites <span class=\"npc-keyword\">\"Barbares\"</span>, \"Incultes\", \"Rite de Passage\" et il vous donnera une énigme afin que vous lui prouviez que vous n’êtes pas ignorant. La voici:</p>\n</li>\n  <li>\n<p>\"Dos\" \"vaneslae\" \"navidal\", \"Kadrim\" \"lok\" \"ungrim\" \"dok\", \"Somalina\" \"oundi\" \"inesora\", \"Tharrgra\" \"nethdrovar\". Si vous pouvez me dire ce que cela signifie, non seulement je vous concéderai l’accès au dernier étage mais je serai en plus gentil avec vous. Voici un <b>indice</b>: vous serez incapable de résoudre cette énigme si vous n’allez pas visiter le sous-sol de la Bibliothèque.</p>\n</li>\n  <li>\n<p>Dirigez-vous vers les sous-sols où les 4 savants résident. Parlez-leur.</p>\n</li>\n  <li>\n<p>Au savant disant <span class=\"npc-keyword\">\"language of the Elves\"</span> (Pièce au nord-ouest), dites <span class=\"npc-keyword\">\"Dos vaneslae navidal\"</span>. Il répondra: \"Pour regarder quelqu'un\".</p>\n</li>\n  <li>\n<p>Au savant disant <span class=\"npc-keyword\">\"language of the Dwarves\"</span> (Pièce au sud-ouest), dites <span class=\"npc-keyword\">\"Kadrim lok ungrim dok\"</span>. Il répondra: \"Il suffit d'avoir des yeux\".</p>\n</li>\n  <li>\n<p>Au savant disant <span class=\"npc-keyword\">\"language of Faeries\"</span>, (Pièce au nord-est), dites <span class=\"npc-keyword\">\"Somalina Oundi Inesora\"</span>. Il répondra: \"Pour reconnaitre sa propre ignorance\".</p>\n</li>\n  <li>\n<p>Au savant disant <span class=\"npc-keyword\">\"language of Dragons\"</span> (Pièce au sud-est), dites <span class=\"npc-keyword\">\"Tharrgra nethdrovar\"</span>. Il répondra: \"Il faut ouvrir ses yeux\".</p>\n</li>\n  <li>\n<p>Retournez au 3e étage et reparlez avec Custodian. Dites <span class=\"npc-keyword\">\"Oui\"</span>, \"Pour regarder quelqu'un\", \"Il suffit d'avoir des yeux\", \"Pour reconnaitre sa propre ignorance\", \"Il faut ouvrir ses yeux\" et vous obtenez l’accès complet à la Bibliothèque. Dites <span class=\"npc-keyword\">\"Accès\"</span>, \"Oui\" et vous serez téléporté au 4e étage.</p>\n</li>\n  <li>\n<p>Parlez à un des bibliothécaires. Dites <span class=\"npc-keyword\">\"Oui\"</span>, \"Echange de l'essence\", \"Corps materiel\", \"Ogrimar\", \"Lothar le juste\", \"Abandonna\", \"Elvenweave\", \"Coeur\" et vous réaliserez que Olin Haad tente de ramener Gluriurl à la vie.</p>\n</li>\n  <li>\n<p><b>Vous recevez 500.000 xp.</b></p>\n</li>\n  <li>\n<p>Parlez aux deux autres bibliothécaires et écoutez-les. L’un vous parlera de la pierre noire et l’autre du \"Harbringer\". Dirigez vous vers le château d’Olin Haad.</p>\n</li>\n\n</ul>",
        "images": [],
        "order": 26
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<ul>\n  <li>Trouvez une feuille d'arbre rose dropée par Araf Kul(camp orc) et une pomme (vendue à Lighthaven).</li> <li>Apportez-les à Dunikus Cathbad, au camp des Druides, et dites <span class=\"npc-keyword\">\"potions\"</span>.</li> <li><b>Récompense</b> : Une fiole de liquide bleuté.</li> <li><b><u><b>Gain</b> : 125k xp</u></b></li>\n</ul>",
        "images": [],
        "order": 8
      },
      {
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "La bénédiction de Zélina",
        "description": "<ul>\n  \n  <li>\n<p>Rendez vous au temple de LH. Parlez à Zélina, dites <span class=\"npc-keyword\">\"travail\"</span> ou simplement \"bénédiction\" ou même \"béné\" et elle vous proposera une bénédiction.</p>\n</li>\n  <li>\n<p>Dites <span class=\"npc-keyword\">\"oui\"</span> en faisant <b>attention</b> qu'il n'y ait aucun obstacle</b> entre elle et vous (sinon c'est l'obstacle qu'elle bénira).</p>\n</li>\n  <li>\n<p>Du level 1 au level 25, la bénédiction de 600PV qui dure 40 minutes vous coûtera 1000 po. Au-delà elle refusera de vous aider.</p>\n</li>\n  <li>\n<p><b>Remarque</b> : cette bénédiction booste aussi l'attaque et l'archerie.</p>\n</li>\n  <li>\n<p></li>\n  <li></p>\n</li>\n  <li>\n<p></p>\n</li>\n\n</ul>",
        "images": [],
        "order": 0
      }
    ],
    ...
    "steps": [
      {
        ...
        "description": "<ul>\n  \n  <li>\n<p>Vous devez être séraphin ou néphilim.</p>\n</li>\n  <li>\n<p>Dites « e<i>ntrer »</i> puis « <i>oui »</i> au <b>Gardien Vortimer</b> qui vous remettra alors la <b>Clef de l'Asile</b>.</p>\n</li>\n  <li>\n<p>Pour pouvoir progresser vous devrez aussi rechercher puis tuer le patient en fuite (drop de l'autorisation J4). Sa <b>position</b> est environ Distraire\" puis \"Adieu\" au gardien. Ensuite, vous avez moins de 5 secondes pour lui dire <span class=\"npc-keyword\">\"Yeux de tarentules\"</span> puis \"oui\".</p>\n</li>\n  <li>\n<p><b>Cette quête peut être effectuée à volonté!</b></p>\n</li>\n  <li>\n<p></p>\n</li>\n\n</ul>",
        "images": [],
        "order": 1
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "title": "Le saphir",
        "description": "<ul>\n  \n  <li>\n<p>Allez voir le Roi Théodore (3ème étage) et dites <span class=\"npc-keyword\">\"Pierre de saphir\"</span>. Il vous demandera une peau d’antilope tannée. Dites <span class=\"npc-keyword\">\"tannée\"</span> et il vous enverra voir Samuel (au 2ème, près du trône).</p>\n</li>\n  <li>\n<p>Dites à Samuel \"tannée\" et il vous enverra voir Drardos (dans une maison vers (<b>1590,2575</b>) près de l’entraîneur de \"Transpercer Armure\"). Drardos vous demande une peau d’antilope que vous pouvez facilement vous procurer en tuant le-dit animal. Muni d'une peau d'antilope, dites <span class=\"npc-keyword\">\"tannée\"</span> à Drardos. Il vous demandera 1.400 pièces d’or, répondez <span class=\"npc-keyword\">\"oui\"</span> et il vous tannera la peau (parfois il peut rater et s'excusera platement).</p>\n</li>\n  <li>\n<p>Ensuite retournez voir le Roi Théodore. Dites <span class=\"npc-keyword\">\"pierre de saphir\"</span>, \"oui\" et il vous échangera la peau tannée contre un saphir. <b>Attention</b> :</b> Le roi vous prendra toutes les peaux d'antilope tannées que vous avez sur vous !!</p>\n</li>\n\n</ul>",
        "images": [],
        "order": 2
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<ul>\n  <li>Les Gardes de l’ombre dropent des calices d'or.</li> <li>Ramenez-en un à Frère Thorkas au temple de Silversky et dites <span class=\"npc-keyword\">\"calice d'or\"</span> et \"oui\".</li> <li>Vous serez récompensé par 250.000 xp et un anneau de foi.</li>\n</ul>\n<br/>\n<p><b>Remarque</b>: Vous pouvez effectuer cette quête à volonté</p>\n<br/>\n<p><b>PNJ</b> impliqués</b>: Frère Thorkas</p>\n<br/>\n<p><b>Récompense</b> acquise</b>: Anneau de foi (15 Int, 65 Sag), <b>250K xp</b></p>\n<br/>\n<p><br/></p>",
        "images": [],
        "order": 11
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<ul>\n  \n  <li>\n<p>Cherchez le <b>PNJ</b> nommé Theoran Feizdir (dans une petite maison située dans la plaine au sud-est de Stonecrest) et dites <span class=\"npc-keyword\">\"anneau de vraie foi\"</span>. Il vous demandera:</p>\n</li>\n  <li>\n<p>1 Anneau de foi (de la quête de l’anneau de foi)</li>\n  <li>1 Graal de pureté (droppé par les centaures vengeurs de Stoneheim)</li>\n  <li>2 Fioles d’ eau bénite (préparées par Theoran Feizdir [pour une fiole d’eau cristalline] ou Frère Thorkas [pour une fiole d’eau cristalline et 1.000 pièces d’or]), Mots-clés : \"eau bénite\", \"oui\".</p>\n</li>\n  <li>\n<p>Ramenez-lui les objets et dites <span class=\"npc-keyword\">\"anneau de vraie foi\"</span>, \"oui\" et il vous donnera l’anneau.</p>\n</li>\n  <li>\n<p>Remarque #1: Vous pouvez effectuer cette quête à volonté.</li>\n  <li>Remarque #2: Quand vous dites <span class=\"npc-keyword\">\"adieu\"</span> à Theoran Feizdir il invoque une Aura Protectrice pour vous. Elle vous donne +20 à toutes les résistances et dure 2 minutes 30 secondes.</p>\n</li>\n  <li>\n<p><b>PNJs</b> impliqués:</b> Theoran Feizdir, Frère Thorkas (facultatif).</p>\n</li>\n  <li>\n<p><b>Récompense</b> acquise:</b> Anneau de vraie foi (prérequis : 15 Int, 90 Sag)</p>\n</li>\n\n</ul>",
        "images": [],
        "order": 5
      },
      {
