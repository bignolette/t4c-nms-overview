...
export const quests: Quest[] = [
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "Introduction",
        "description": "<p>Le repop de ces coffres est de 4 heures pour deux persos différents, mais de 8 heures (comme oracle)pour le même perso... </p><p><b><big>Le Coffre Sud</big></b> (coffre des gardiens du coffre) </p><p>Il drop aléatoirement plusieurs items parmi: </p><p><b><big>Les deux Coffres des trolls érudits</big></b> </p><p>Ils dropent aléatoirement plusieurs items parmi: </p><p><b><big>Le Coffre des Abysses</big></b> <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(713, 1757, 3)</span> </p><p>Il drop aléatoirement plusieurs items parmi: </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 0
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "INTRODUCTION",
        "description": "<p>Cette quête est ouverte à tous les niveaux. Il est cependant conseillé d'avoir fait la quête Crimson jusqu'à la tablette RST. Mais ce n'est pas indispensable. J'ai eu 18/20 en courant à pied jusqu'à Orkanis dans l'épreuve 4. </p><p><u>Récompenses :</u> </p><p>- Bonne surprise : Toujours si vous terminez les 4 épreuves : <b>Un bonus de chance de +10</b> permanent, même après reroll mais pas après renaissance. </p><p>- Entre 15 et 20 de moyenne aux épreuves : <b>le chapeau de diplômé</b> (+25 chance)<span style=\"mso-spacerun:yes\"> </span>et ainsi qu’une bourse d’expérience indroppable (environ 7% du level en cours quand vous l'activez) et le bonus chance. Conseil : utilisez la bourse aux levels les plus longs (195 à 200) ou à très haut level. </p><p class=\"MsoNormal\">- Moins de 10 vous obtenez un masque de cancre (+5 chance) et, nous sommes trop gentils, +10 de chance permanents.</p><p>Il faut finir les quêtes même si vous avez 0 car vous aurez toujours le bonus +10 en chance. </p><p class=\"MsoNormal\">Vous ne pouvez faire la quête qu'une seule fois par renaissance donc <b>préparez-la bien !!</b> </p><p class=\"MsoNormal\">Une bénédiction (p.e. de Zélina) vous aidera bien la tâche si vous êtes de petit niveau (et vous évitera de mourir bêtement (épreuve 4 ou 5)). </p><p class=\"MsoNormal\">Une fois à Windhowl, achetez deux parchemins de WH (sauf si vous disposez d'un portail ou d'un sanctuaire à Windhowl) et assurez-vous d'avoir la gemme HDV de Lighthaven. </p><p>La durée est chronométrée en temps <span class=\"npc-keyword\">\"in game \"</span>. Après chaque question, faites un screen (ctrl + h) de la question puis déconnectez-vous ou switchez sur un autre perso et allez voir le screen dans le répertoire du jeu dans \"mes documents\" (sous répertoire \"ScreenShot\") et étudiez la question. Puis reconnectez-vous. </p>",
        "images": [
      ...
      {
        "title": "LA QUETE",
        "description": "<p class=\"MsoNormal\">Allez voir <b>Madame Flichère</b> à la fontaine de Windhowl.<br>Vous devrez réussir 6 épreuves avec une moyenne générale égale ou supérieure à 15 sur 20.</p><p class=\"MsoNormal\">Après chaque épreuve, retournez voir Madame Flichère qui vous enverra faire la suivante.</p><p class=\"MsoNormal\">Les six épreuves sont (les PNJ sont au Sud de la ville) :</p>",
        "images": [],
        "order": 1
      },
      {
        "title": "1) Professeur Indetroikat épreuve de calcul (chronométrée)",
        "description": "<p class=\"MsoNormal\">Réponses selon la question posée :<br>1<span style=\"mso-spacerun:yes\"> (</span>14*8/7-4)/2 = 6<br>2<span style=\"mso-spacerun:yes\"> (</span>17*9/3-1)/2 = 25<br>3<span style=\"mso-spacerun:yes\"> (</span>13*6/3-8)/2 = 9<br>4<span style=\"mso-spacerun:yes\"> (</span>19*9/3-1)/2 = 28<br>5<span style=\"mso-spacerun:yes\"> (</span>16*8/4-2)/2 = 10</p>",
        "images": [],
        "order": 2
      },
      {
        "title": "2) Professeur Senfaute épreuve d'orthographe (chronométrée)",
        "description": "<p class=\"MsoNormal\"> <b>Parlez-lui (surtout soyez poli avec elle !!! ne jamais dire je m'en fous)</b></p><p class=\"MsoNormal\">Réponse selon la question posée :<br>1<span style=\"mso-spacerun:yes\"> c</span>auchemard envoyers athé pieds suffire<br>2<span style=\"mso-spacerun:yes\"> a</span>utant voir remboursez tord payons<br>3<span style=\"mso-spacerun:yes\"> </span>prêt demie-heure maline sensée marrons<br>4<span style=\"mso-spacerun:yes\"> </span>soient repère aie laissés tué<br>5<span style=\"mso-spacerun:yes\"> </span>quand ou tribue s'en tout</p>",
        "images": [],
        "order": 3
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>Flocon vous demandera de l'aide afin de récolter un sucre d'orge. Pour créer cet objet, il vous faudra 2 betteraves, ainsi que 2 sachets de grains d'orge. </p><p>Au Troll d'Arakas les bettraves </p><ul><li>Emplacements des plants de betterave. 20 min solo 10 min à 2 <ul><li>1484,246,0</li> <li>1565,140,0</li> <li>1604,270,0</li> <li>1628,203,0</li></ul></li></ul><ul><li>1484,246,0</li> <li>1565,140,0</li> <li>1604,270,0</li> <li>1628,203,0</li></ul><p>Au territoire Kraanian l'orge </p><ul><li>Emplacements des plants d'orge. 20 min solo 10 min à 2 <ul><li>1976,715,0</li> <li>2019,632,0</li> <li>2094,640,0</li> <li>2114,750,0</li></ul></li></ul><ul><li>1976,715,0</li> <li>2019,632,0</li> <li>2094,640,0</li> <li>2114,750,0</li></ul><p>Le taux de drop doit être 20 à 25%. </p><p>Une fois ces 4 objets obtenus, rendez-vous chez le vieil Ermite a la cave des brigands (voleurs). Parlez à Alfrid Bécher et dites lui <span class=\"npc-keyword\">\"orge\"</span>. Il transformera vos deux sachets de grains en une décoction d'orge perlée. </p><p>Ensuite, allez à WH pour parler à Pomme Deschamps près de l'écurie de WH et dites-lui <span class=\"npc-keyword\">\"sucre\"</span> afin qu'elle vous donne un sachet de sucre cristallisé en échange de vos deux betteraves. </p><p>Localisez Florentin, le boulanger, dans une maison au Sud-Ouest de WH <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1685,1349,0)</span>, non loin de Pomme, et dites lui <span class=\"npc-keyword\">\"sucrerie\"</span>. Suivez les mots clés afin qu'il vous remette enfin le sucre d'orge que vous pourrez alors aller remettre à Flocon. </p><p>Récompense : 1 cadeau de Noël. </p>",
        "images": [],
        "order": 9
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>- Rendez-vous auprès de <b>Gildric Moray <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1200,2880,0)</span></b>, un pêcheur situé au sud-ouest du camp des druides de Raven's Dust. Dites-lui <b>Aide</b>, <b>Prêt</b>. Il vous demandera alors une Canne à pêche. En fait il suffit d'aller le voir quand vous aurez les cannes. </p><p>- Allez à Silversky dans la ville des Métiers (vers l'est). L'ébéniste <b>Maletis <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1652,2542,0)</span> </b>peut vous confectionner une canne à pêche avec les objets suivants : </p><ul><li><b>2 branches de noyer</b> (arbres à abattre avec une hache du bûcheron expérimenté dropée par les vers des sables du désert RD - voir la section ressources du wiki - ou demandez sur le CC main...)</li> <li><b>1 boyau d'horreur railleuse</b> (horreurs railleuses à l'ouest RD)</li> <li><b>1 dard de scorpion</b> (scorpions du désert RD) en guise d'hameçon</li></ul><p>Dites-lui <b>Créations, Cannes a pêche, Fabriquer, Ingrédients. </b>Et hop il vous confectionne une canne à pêche (dropable). Remarque : avec suffisamment d'ingrédients, vous pouvez en fabriquer plusieurs à la suite, en répétant le mot clé <b>Ingrédients</b> </p>",
        "images": [],
        "order": 1
      },
      {
        "title": "2) Echange de la canne à pêche contre la bouteille contenant la carte au trésor",
        "description": "<p>- Retournez voir <b>Gildric Moray <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1200,2880,0)</span></b>, il vous échangera la canne à pêche contre une bouteille contenant un parchemin. Cliquez dessus et vous obtiendrez une petite carte au trésor. </p>",
        "images": [],
        "order": 2
      },
      {
      ...
      {
        "title": "Les boussoles",
        "description": "<p>De plus, les pirates peuvent laisser tomber des <b>boussoles en or</b>. Ces boussoles (dropables) vous donneront 50k d'expérience chacune. Ramenez-les à <b>Gildric Moray le pêcheur <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1200,2880,0)</span></b> après votre sortie du donjon. </p><p>N.B. Ce donjon est difficilement faisable seul même proche du level 50 et avec un bon équipement. Il est préférable d'être au minimum deux joueurs, surtout pour tuer le Capitaine. Vous avez un maximum d'une heure pour faire tomber de 1 à 3 clés et donc pour faire apparaître de 1 à 3 fois ce brave Capitaine, sans quoi vous serez téléporté a votre sanctuaire sans récompense. A 2 il vaut mieux faire tomber de suite la bonne clé sinon le temps restant risque d'être trop court. </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>Allez voir Solange, avec 50 feuilles d'arbre démoniaque dans votre inventaire, dans une maison aux druides RD. Vous pourrez échanger vos 50 feuilles versus une <span class=\"npc-keyword\">\"décoction démoniaque \"</span> en disant ''décoction'' à Solange. La décoction démoniaque vous sera utile pour votre prochain accès au marécage. Vous libérerez ainsi de la place dans votre inventaire. </p>",
        "images": [],
        "order": 1
      },
      {
      ...
      },
      {
        ...
        "description": "<p>Allez voir Sigvurd, dans la maison du forgeron au Nord de la ville de Redwall et parlez-lui. Il vous enjoint de trouver un arbre situé au Nord et de lui parler... </p><p><b>Dialogue avec Sigvurd :</b> </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> {*ouvre difficilement les yeux*} ... Ah ... Euh ... Bonjour ... {*tremble de froid*} </p><p>-- Vous avez dit : travail </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> Regardez-moi ... Comment voulez-vous que je puisse <span class=\"npc-keyword\">\"encore\"</span> travailler ? &lt;&gt;Je ne peux même plus sortir de ce lit ... {*marque une longue pause*} </p><p>-- Vous avez dit : encore </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> Oui ... {*parle difficilement*} ... On ne dirait pas ... en réalité ... je suis aventurier ... {*prend une grande bouffée d'air avant de continuer*} ... Je suis rentré depuis quelques semaines ... mon \"état\" ne cesse d'empirer ... Je ne peux presque plus bouger ... </p><p>-- Vous avez dit : état </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> Nous avons traversé un \"marécage\" ... Nous étions six ... Mes compagnons n'y ont pas survécu ... &lt;&gt;Je ... je ne sais pas ce que j'ai ... {*remonte sa manche pour vous montrer ses avant-bras*} ... ce sont des griffures ... &lt;&gt;Je ... je suis le \"dernier\" ... {*plisse le front*} </p><p>-- Vous avez dit : marécage </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> Un marécage ... oui ... {*a une quinte de toux*} ... une stupide idée ... &lt;&gt;Nous pensions y trouver un trésor ... &lt;&gt; Rhaaaa ... si seulement nous n'avions pas écouté cet \"arbre\" de malheur ... </p><p>-- Vous avez dit : arbre </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> C'est un arbre maudit ! ... {*perd son souffle en s'exclamant*} ... &lt;&gt;N'y \"allez\" pas ou vous mourrez ! ... Tous les arbres sont maudits !!! ... Et celui là en particulier ... &lt;&gt;En fait ... il parle ! Mais comment voulez-vous qu'un arbre puisse parler ? ... {*sent la folie le gagner*} </p><p>-- Vous avez dit : allez </p><p>-- {Sigvurd}<span class=\"npc-keyword\">\":\"</span> Il est au nord ... Mais n'y allez pas !!! ... {*tousse en essayant de hausser le ton*} ... Il est maudit ... Je vous l'ai déjà dis ! {*insiste*} </p><p><b>Trouvez cet arbre....il est situé au Nord de RW dans les eaux marécageuses vers l'Ouest.</b> </p><p><b>Si vous tentez de lui parler de suite il vous répondra :</b> </p><p>-- Les feuilles de l'arbre bougent avec le vent. </p><p><b>Bien évidemment, comme pour Greyleaf, il vous faut une pierre verte de l'esprit de la forêt pour lui parler. Procurez-vous cette pierre comme vu plus haut et reparlez-lui :</b> </p><p>-- {Chêne millénaire}<span class=\"npc-keyword\">\":\"</span> Bonjour jeune aventurier </p><p>-- Vous avez dit : travail </p><p>-- {Chêne millénaire}<span class=\"npc-keyword\">\":\"</span> Je suis le gardien du marécage ...seuls les courageux aventuriers peuvent y \"entrer\". </p><p>-- Vous avez dit : entrer </p><p>-- {Chêne millénaire}<span class=\"npc-keyword\">\":\"</span> Si vous voulez y entrer, vous devrez d'abord me \"montrer\" votre valeur et vos aptitudes à pouvoir y survivre ! </p><p>-- Vous avez dit : montrer </p><p>-- {Chêne millénaire}<span class=\"npc-keyword\">\":\"</span> Bien ... Si vous pensez pouvoir y survivre ... Trouvez 50 \"feuilles\" d'arbre démoniaque ou une \"décoction\" démoniaque, peu importe ... l'un ou l'autre. &lt;&gt;Ensuite vous devrez trouver un \"éclat\" d'âme d'arbre Sintelle. &lt;&gt;Quand vous aurez \"tout\" rassemblé, revenez me voir, je vous y enverrai. </p><p>-- {Chêne millénaire}<span class=\"npc-keyword\">\":\"</span> Rapportez-moi une cinquantaine de feuilles d'arbre démoniaque pour me prouver que vous pourrez survivre une fois dans le marécage ! </p><p><b>Trouvez les ingrédients, groupez avec si possible 3 ou 4 amis et reparlez-lui :</b> </p><p>-- Des aventuriers s'aventurent péniblement dans les marécages de l'éternelle agonie. </p><p>-- {Chêne millénaire}<span class=\"npc-keyword\">\":\"</span> Vous étiez prévenus ... Allez en paix ! </p><p><b>Et</b> <b>vous êtes téléportés...</b> </p>",
        "images": [],
        "order": 3
      },
      {
    ...
    "steps": [
      {
        ...
        "description": "<p>Vous devez être déchu pour réaliser cette quête. </p><p>Pour commencer, sachez qu'il est inutile de débuter la quête avant le level 25. </p><p>Allez voir <b>Muffin</b> (un Kobold dans la cave de l'île des Démonicons) dites lui <span class=\"npc-keyword\">\"travail\"</span> \"guider\" puis \"service\". </p><p>Allez parler à <b>Delvar Dorndir</b> (près de la montagne au Sud-Ouest du camp gobelin), dites lui <span class=\"npc-keyword\">\"potion\"</span> et \"oui\".<br>Retournez voir <b>Muffin</b>, dites lui <span class=\"npc-keyword\">\"Service\"</span>, \"aider\" et \"avancer\". </p><p>Tuez les deux dragons d'Arakas Dasrinn et Dimith. L'un se trouve au nord de la cave située sur l'île des kraaniens et l'autre se trouve après le labyrinthe près du village des nains. </p><p>De retour chez notre ami <b>Muffin</b>, dites lui <span class=\"npc-keyword\">\"avancer\"</span>, \"continuer\", \"îles\" et \"matériel\". Il vous enverra chercher : </p><ul><li>un anneau d'or (quête de Jarko, chef de guerre gobelin, assassin...)</li> <li>une cotte de mailles bénie</li> <li>un scalpel de chirurgien</li></ul><p>Muni de ces objets redites lui <span class=\"npc-keyword\">\"matériel\"</span>, \"continuer\" et il vous donnera un parchemin d'accès à SilverSky. </p><p>Une fois arrivé à Silversky, parlez rapidement à <b>Porcine Citre</b> <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1600,2450,0)</span>. Dites lui <span class=\"npc-keyword\">\"travail\"</span> et, quand elle vous demandera si vous voulez devenir un de ses cochonnets, répondez <span class=\"npc-keyword\">\"oui\"</span>. Cela fixera votre sanctuaire dans l'enclos des cochons!! </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 0
      }
    ],
    ...
    "steps": [
      {
        ...
        "description": "<p>Près du temple de Lighthaven se trouve un PNJ (vêtu de bleu) appelé Samaritain de Lighthaven. Parlez lui et il vous demandera si vous avez des questions à poser. Dites \"<b>Oui</b>\" puis \"<b>Tâche</b>\". Il vous donnera votre première quête qui sera de tuer 15 rats dans les sous-sols du temple. Allez les tuer, puis retournez le voir en disant \"<b>Oui</b>\" puis \"<b>Tâche</b>\". Il vous récompensera avec 2.500 points d'expérience. </p><p><b>Note :</b> Au niveau 1, les rats peuvent vous donner du fil à retordre. Au premier sous-sol du temple (dans une pièce située au Nord puis à l'Ouest), se trouve un PNJ appelé Nevanis. Dites lui \"<b>Guérir</b>\" et il vous soignera. Restez près de lui et dès que vous serez en difficulté, dites lui \"<b>Guérir</b>\". </p><p><b>Note 2</b> : Zélina au temple vous bénira pour 1000 po (approchez-vous d'elle et dites-lui \"bénédiction\"). Vous aurez un bonus de 600PV pour <b>40 minutes cumulable à une bénédiction classique.</b> </p><p><b>PNJs concernés: </b>Le samaritain de Lighthaven, Nevanis (facultatif) </p><p><b>Récompense obtenue:</b> <b><u>2.500 Points d'expérience</u></b> </p>",
        "images": [],
        "order": 0
      },
      {
        "title": "La quête de l'or du dragon (bonifiée) (non répétable)",
        "description": "<p>A Lighthaven, entre la fontaine et le cimetière, se trouve un dragon nommé Darkfang (vous ne pouvez pas le louper). Dites lui \"<b>Or</b>\", \"<b>Oui</b>\" et il vous donnera 5.000 pièces d'or. De plus, tant que vous n'aurez pas atteint le niveau 6, vous pourrez lui dire \"<b>Soin</b>\" et il guérira partiellement vos blessures. </p><p><b>PNJ concerné: </b>Darkfang </p><p style=\"text-align: left;\"><b>Récompense obtenue:</b> <b><u>5000 pièces d'or</u></b> (200 à l'origine)</p>",
        "images": [],
        "order": 1
      },
      {
        "title": "La quête du pilleur de tombe (bonifiée) (non répétable)",
        "description": "<p>Allez parler à Darkfang (le dragon de Lighthaven) et dites lui \"<b>Pilleur de tombe</b>\". Il vous demandera de tuer le pilleur de tombe. Vous le trouverez dans la crypte sous le cimetière. Tuez-le et retournez voir Darkfang. Dites lui \"<b>Pilleur de tombe</b>\" et il vous récompensera avec 40 k points d'expérience !! </p><p><b>Note #1:</b> Pour tuer facilement le pilleur de tombe, laissez les momies l'attaquer. Quand il devient <span class=\"npc-keyword\">\"rouge\"</span>, achevez le (attention, souvent il y a trop de momies et dans ce cas vous devrez vous depêcher) </p><p><b>Note #2:</b> S'il est tué, il faut attendre environ 30 minutes avant qu'il ne réapparaisse. </p><p><b>PNJ concerné: </b>Darkfang </p><p><b>Mini-Boss concerné: </b>Le pilleur de tombe </p><p><b>Récompense obtenue:</b> <b><u>40.000 points d'expérience</u></b> ! </p>",
        "images": [],
        "order": 2
      },
      {
      ...
      },
      {
        ...
        "description": "<p>Allez voir le Bourgmestre Sunrock à Windhowl et dites lui <span class=\"npc-keyword\">\"Jarko\"</span>. Il vous dira qu'il recherche son grimoire. Allez à la grotte J au niveau - 3 et trouvez Jarko le Necromancien (il a l'apparence d'un mage humain). Tuez le <b>vous-même</b> (10K xp) et récupérez son grimoire (repop 25 minutes si vous le tuez plusieurs fois pour la 1ère option) </p>",
        "images": [],
        "order": 13
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>Pour commencer la quête, dites le mot-clef \"tâche\" à Nilhem. </p><p>Vous devez lui apporter 25 pieds d'innocents. </p><p>Les pieds d'innocents s'obtiennent sur les Ogres Ignobles. </p><p>Les Ogres Ignobles se trouvent DANS Lighthaven. Vous les trouverez facilement au sud des champs de blé (là où il y a les cochons). </p><p><b>Récompenses:</b> </p><ul><li>Le Buff de l'Âme de Nilhem, d'une durée de 15 minutes (+100 à toutes vos caractéristiques, +1500 PV PM et Attaque, +50 de CA, +50 à toutes les puissances, +490 d'esquive).</li> <li>5 000*lvl points d'XP</li></ul><p><b>Cette quête peut être effectuée a volonté.</b> </p>",
        "images": [],
        "order": 1
      },
      {
    ...
    "steps": [
      {
        ...
        "description": "<p>Vous devez être séraphin ou néphilim. </p><p>Dites « e<i>ntrer »</i> puis « <i>oui »</i> au <b>Gardien Vortimer</b> qui vous remettra alors la <b>Clef de l'Asile</b>. </p><p>Pour pouvoir progresser vous devrez aussi rechercher puis tuer le patient en fuite (drop de l'autorisation J4). Sa position est environ <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(2450,260,0)</span>. </p><p>Puis traversez tout l'asile jusqu'au dernier étage pour trouver Mad Madrigan et tuez-le (respawn : 20 minutes) jusqu'à ce qu'il drope la clé de son coffre. </p><p>Puis rendez-vous à son coffre (Madrigan's chest) et ouvrez-le en espérant y trouver son beau chapeau !! </p><p><b><u>Respawn des coffres</u></b> </p><p>Coffre de Madrigan : 33mn à 2, 50mn seul </p><p>Autres coffres : 16-20mn à 2, 25-26mn seul </p><p><b><u>Les Autorisations</u></b> </p><p>Les autorisations C1, C5, J1 et J4 sont nécessaires pour franchir les portails successifs. </p><p>(les autres autorisations sont inutiles) </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "title": "Méthode Solo",
        "description": "<p>Préparez les mots-clefs (\"Nécessaire\", \"Distraire\"). Dites le mot-clef <b>\"Distraire\"</b> au gardien. A partir de ce moment il vous reste 5 secondes avant d'être téléporté(e) en prison. Dites le mot-clef <b>\"nécessaire\"</b> à Audrey. A ce moment si vous avez les ingrédients sur vous, vous gagnez 80.000 xp et Audrey vous remet la robe, puis vous allez en prison. Vous devez être rapide pour que cela fonctionne en solo mais c'est faisable. Entrez les mots-clefs avant de commencer et utilisez <b>CTRL+HAUT</b> pour les répéter rapidement. </p>",
        "images": [],
        "order": 1
      },
      {
        "title": "Méthode Coopérative",
        "description": "<p>Vous aurez besoin de l'aide d'un comparse qui distraira le garde en lui disant le mot-clef <b>\"Distraire\"</b>, et c'est lui qui sera téléporté en prison pendant 10 minutes, il pourra tout de même s'échapper immédiatement s'il le désire grâce à la RST, Mot de rappel ou un Parchemin. Dites ensuite les mot-clefs <b>\"Nécessaire\"</b> puis <b>\"oui\" </b>à Audrey (en moins de 5 secondes là aussi), elle vous remettra une robe si vous avez les ingrédients et l'or sur vous. </p><p><b>Récompenses:</b> Une robe de couleur aléatoire parmi Brunie, Rose, Bleutée, Jaune ou Orangée (<u>Bonus</u> : +5 Int +5 Sag +2 CA -25 Esquive, <u>Prérequis</u> 12 End 28 Sag 28 Int) . </p><p>Vous gagnerez aussi 80.000 xp de récompense. </p><p><br> <b>P.S.</b> Si vous avez envie de calmer les nerfs du garde après avoir eu la robe, vous pouvez compléter la quête \"Le Gardien et les yeux de tarentules\"! </p><p><b>Cette quête ne peut être effectuée qu'une seule fois.</b> </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 2
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>•Rapportez <b>10 yeux de tarentule</b> au PNJ \"George Le Gardien\" dans la même maison que le PNJ Audrey (quête des robes colorées) aux Druide d'Arakas. </p><p>Il vous récompensera par 25 000 pièces d'or et des points d'XP selon votre niveau soit (2k XP * LVL) jusqu'au niveau 50 et (5k XP * LVL) au-delà. </p><p><br> <b>Mot clef pour distraire le gardien:</b> \"distraire\" </p><p><b>Mot clef pour donner les yeux:</b> \"Yeux de tarentules\" </p><p>•<b>Attention:</b> Pour que \"George Le Gardien\" accepte de vous parler et de prendre vos yeux de tarentules, vous devrez le \"Distraire\" avant. Vous serez alors téléporté(e) en prison pour une durée de 10 minutes mais vous pouvez échapper avec la Runed Stone Tablet, avec Mot de rappel ou avec un parchemin. Ensuite, retournez voir le Gardien et il acceptera de prendre vos yeux (si personne ne lui a parlé entre-temps). Bien sûr l'idéal est de faire la quête en duo, l'un qui distrait le gardien, l'autre qui donne les yeux et reçoit l'XP! </p><p><b>Méthode Solo:</b> Dites <span class=\"npc-keyword\">\"Distraire\"</span> puis \"Adieu\" au gardien. Ensuite, vous avez moins de 5 secondes pour lui dire <span class=\"npc-keyword\">\"Yeux de tarentules\"</span> puis \"oui\". </p><p><b>Cette quête peut être effectuée à volonté!</b> </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 1
      }
    ],
    ...
    "steps": [
      {
        ...
        "description": "<p>Allez voir Elysse à LH dans la maison à l'est de la taverne. </p><p>Dites lui : \"travail\", puis \"teindre\" (pour vous teindre les cheveux) ou <span class=\"npc-keyword\">\"couper\"</span> (pour avoir une petite coupe surprise qui durera une heure) </p><p>Si vous avez choisi \"teindre\" vous aurez le choix entre 5 couleurs différentes: Blond, Châtain, Brun, Roux ou Gris. Faites vous plaisir! </p><p>Enfin si vous lui dites <span class=\"npc-keyword\">\"retirer\"</span> vos cheveux colorés redeviendront noirs. </p><p>N'oubliez pas de prendre la coquette somme de 2 550 pièces d'or par travail demandé. </p>",
        "images": [],
        "order": 0
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "title": "Clé Royale #1",
        "description": "<p>Trouvez <b>Celydia </b>(RDC à droite, 1438,2346) <b>le jour </b>au château de Silversky et dites-lui <i>\"clefs royales\"</i> et <i><span class=\"npc-keyword\">\"Reynen\"</span></i> (elle ne vous parlera que le jour). </p><p>Allez à la taverne de la ville, trouvez <b>Laren</b> (1485,2524) et dites-lui aussi <i><span class=\"npc-keyword\">\"Reynen\"</span></i>. Il vous dira qu’il a une relation avec Adriana et vous enverra voir <b>Belagan</b> (l’assistant d’Adriana). </p><p>Si vous disposez déjà de la clé de <b>Reynen</b> ou si un ami vous peut vous la prêter, vous pouvez sauter la partie qui suit et aller directement au coffre. </p><p>Allez à la salle d'entraînement, trouvez <b>Belagan</b> (1587,2524) et dites <i><span class=\"npc-keyword\">\"Reynen\"</span></i>, <i>\"Oui\"</i> et il vous demandera un livre de guerre que vous pouvez acheter à <b>Tobias <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(2864,193,4)</span></b>, au 1er étage (au centre) du château en lui disant <i>\"livre de l'art de la guerre\"</i> pour un prix de 15.000 pièces d’or. </p><p>Ramenez le livre à <b>Belagan</b> et dites-lui <i>\"livre de l'art de la guerre\"</i>, <i><span class=\"npc-keyword\">\"Reynen\"</span></i>. Faites attention à ce qu’il vous dira car il est possible qu’il vous demande un autre livre pour Adriana (il semblerait que dans certains cas cette variante soit buguée) mais en général il vous enverra directement voir <b>Reynen Aspicdart</b>. </p><p>Allez à la cave des illusionnistes en passant par le désert (voyez la carte de RD) et trouvez Reynen. Dites-lui <i>\"clefs royales\"</i> et il vous dira qu’elle est dans un coffre qui est peut-être (ben tiens !) verrouillé. Trouvez le coffre qui est, bien sûr, verrouillé. Retournez voir <b>Reynen</b>. Dites <i><span class=\"npc-keyword\">\"coffre\"</span></i>, puis <i>\"verrouillé\"</i>, puis <i>\"oui\"</i> et il vous donnera la clé pour ouvrir le coffre. </p><p>Vous disposez maintenant de la clé de Reynen. </p><p>Restez ou allez dans la cave des illusionnistes (entrée du désert, voir carte RD). Rendez-vous au coffre de Reynen et ouvrez le à l'aide de la clé de Reynen pour récupérer la clé royale n°1 (attention, il faut souvent l'ouvrir plusieurs fois pour obtenir la clé). </p><ul><li><i>Remarque #1:</i> <ul><li><i>Le coffre drope la clé royale aléatoirement... ou une plume ou une potion. Insistez...(repop 50 minutes seul, 33 minutes à 2).</i></li></ul></li> <li><i>Remarque #2:</i> <ul><li><i>Pour récupérer cette clé, votre Karma doit être au moins de 100. Consultez Le Karma pour savoir comment l’augmenter.</i></li></ul></li></ul><ul><li><i>Le coffre drope la clé royale aléatoirement... ou une plume ou une potion. Insistez...(repop 50 minutes seul, 33 minutes à 2).</i></li></ul><ul><li><i>Pour récupérer cette clé, votre Karma doit être au moins de 100. Consultez Le Karma pour savoir comment l’augmenter.</i></li></ul>",
        "images": [
      ...
      {
        "title": "Clé Royale #2",
        "description": "<p>Pour optimiser vos déplacements, munissez-vous d'une <b>potion d'héroïsme</b> (les guerrier-mages orcs et les orcs berserker en dropent dans la grotte vers le village orc ou au village)Au château de Silversky. </p><p>Puis trouvez <b>Terwin</b> (2ème étage centre). Dites-lui <i>\"clefs royales\"</i>, éventuellement répétez et il vous demandera une potion d’héroïsme . Dites à nouveau <i>\"clefs royales\"</i> à Terwin. Il vous demandera 5000 po et alors seulement vous dira que c’est le chambellan <b>Thomar</b> qui l’a ! (si vous insistez et qu'il ne vous répond pas, c'est que vous n'avez pas fait les 12 frères). </p><p>Allez voir le chambellan <b>Thomar </b>(1er étage centre gauche). Dites-lui <i>\"clefs royales\"</i>. Il vous demandera d'être <b>Champion de la lumière</b>. SI vous ne l'êtes pas encore, dites <span class=\"npc-keyword\">\"oui\"</span> ou <i>\"Champion de la lumière\"</i> et il vous donnera la clé. </p><ul><li><i>Remarque 1: Pour récupérer cette clé, votre Karma doit être au moins de 100. Consultez Le Karma pour savoir comment l’augmenter.</i></li> <li><i>Remarque 2 : Pour récupérer cette clé vous devez avoir parlé aux 12 frères, sinon Terwin ne vous répondra pas utilement même si vous insistez.</i></li></ul>",
        "images": [],
        "order": 3
      },
      {
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "Introduction",
        "description": "<p>Allez au sous-sol de Nieve (2482,2202), trouvez <b>Pancake,</b> un kobold près des pommiers (2000,1790). Dites lui <span class=\"npc-keyword\">\"Mission\"</span>.<br>Partez à la chasse aux trois dragons de Raven's Dust. </p><p>Retournez voir <b>Pancake</b>, dites lui <span class=\"npc-keyword\">\"mission\"</span>, \"deuxième\", \"part\" et \"échange\". Il vous enverra chercher </p><ul><li>un anneau de platine,</li> <li>des bottes noires en peau de lézard,</li> <li>un pourfendeur de gobelin.</li></ul><p>Avec tous ces objets, dites <span class=\"npc-keyword\">\"échange\"</span> a <b>Pancake</b> pour obtenir un parchemin de StoneCrest. </p><p>Une fois arrivé à Stonecrest, parlez rapidement à <b>Forbes Nash</b> (200,760). Dites lui <span class=\"npc-keyword\">\"travail\"</span> et il vous proposera un pacte. Cela fixera votre sanctuaire dans l'enclos des cochons!! </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 0
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "Introduction",
        "description": "<p><b>Rendez visite à Martha</b> <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(2000, 1735, 2)</span>, au sous sol de Niève, parlez-lui. Elle vous demandera de l'aide pour soigner son fils malade, et quand vous lui direz \"<b>pretre emiere</b>\" elle vous enverra voir le prêtre Emière <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(2040,2860,2)</span>, situé dans une maison de la grotte de Niève vers la plaine, pour vous procurer une fleur bleue à lui ramener. </p><p>Trouvez le prêtre Emière ( zone sud-ouest dans la grotte d'accès aux plaines) et demandez lui la <b>fleur bleue</b>, qu'il vous donnera contre 10 peaux de loup le Niève. </p><p>Sortez de la grotte par la sortie vers la plaine de Niève afin de parvenir au terrain de chasse, et allez vers le sud puis vers l'ouest afin de trouver les loups (1480,620,4 et plus à l'ouest). Campez les 10 peaux (il vous faudra environ 100 de CA pour tenir). </p><p>Retournez voir le prêtre, il vous donnera la fleur contre les 10 peaux. </p><p>Ramenez la fleur à Martha qui vous récompensera de <b>200k po et 900 k xp.</b> </p><p>En bonus, parlez à l'enfant, il vous remerciera d'un<b> masque de loup</b> (3CA, +100 archerie et attaque, aucun prérequis). </p><p><b>(Quête non répétable).</b> </p><p><br> </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 0
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p><b>Tripli mage</b> : rendez vous dans le repère de Jarko, cherchez-y <b>Kadjituu</b>, un gobelin de couleur noire, niveau -3, <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1056, 86, 1)</span>. Dites lui <span class=\"npc-keyword\">\"travail\"</span> puis \"peaux\". </p><p><b>Tripli prêtre</b> : allez voir <b>Aqua Laguna</b>, le golem de feu, situé entre la RST de SH et le château de Beltigan, aux alentours de <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(600,920,0)</span> . Dites lui <span class=\"npc-keyword\">\"triplicite\"</span> puis \"peaux\". (attention il prendra la totalité de vos peaux et gemmes). </p><p>Dans les deux cas, le PNJ fabriquera une partie d'armure triplicite aléatoire. Il vous donnera aussi 3M XP pour une partie triplicite prêtre ou mage. Ps: <u><b>(il faut être level 50 ou plus pour le pex).</b></u> </p><p>Vous obtiendrez au hasard plastron, jambières, gants, heaume, ceinture, bottes, bouclier ou enfin robe. </p><p><b>Après quelques semaines d'entraînement, la fabrication est au point et n'échoue plus !</b> </p>",
        "images": [],
        "order": 2
      },
      {
      ...
      },
      {
        ...
        "description": "<p>Rendez vous dans la ville de Niève, dans une maison située aux alentours de <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(2545,2235,0)</span>. </p><p>Vous y trouverez Surya (pour tripli mage) et Phyllis (pour tripli prêtre). </p><p>Dans les deux cas, dites lui <span class=\"npc-keyword\">\"travail\"</span> et en suivant le dialogue, donnez au PNJ 3 pièces d'armure. </p><p>Le PNJ vous donnera en échange la partie que vous lui demanderez. </p><p>Attention : Si vous lui donnez une ou deux pièces et qu'il vous manque le reste, le PNJ ne vous rendra rien. Vous devrez aller chercher dans votre coffre (ou ailleurs) la ou les pièces manquantes pour terminer la quête. </p><p><br> </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 5
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<ul><li>Sortez de Silversky par la porte ouest et suivez le chemin vers le nord. A la seconde intersection, allez vers l’ouest. Suivez le chemin jusqu’à ce que celui-ci s’achève.</li> <li>Vous trouverez à cet endroit <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(880,2450,0)</span> le mini boss nommé Quadros le Borgne (skin Disciple de l'ombre).</li> <li>Tuez-le et espérez qu’il droppe un marteau de Rhodar (indropable) (cela n’arrive pas souvent, venez équipé en chance si possible).</li> <li>Ramassez le marteau et donnez-le (le jour!) à Rhodar Pyras (le marchand d’armes de Silversky situé à l’est de l’entrée du château), dites <span class=\"npc-keyword\">\"marteau\"</span> puis\"oui\".</li> <li>Vous serez récompensé par <b>500K xp</b> et 3.500 pièces d’or.</li></ul><p>Remarque: Vous pouvez effectuer cette quête à volonté. </p><p>Attention : le marteau est indroppable ! </p><p><b>PNJ impliqué</b>: Rhodar Pyras </p><p><b>Mini Boss impliqué</b>: Quadros le Borgne </p><p><b>Récompense acquise: 500K xp</b>, 3.500 pièces d’or </p>",
        "images": [],
        "order": 6
      },
      {
    ...
    "steps": [
      {
        ...
        "description": "<p>Vous devez être déchu pour réaliser cette quête. </p><p>Vous devez avoir réalisé auparavant la quête de l'accès a l'asile ! </p><p>Après avoir récupéré la Fiole de Sang de Forbin, allez sur RD voir le déchu qui se trouve dans la baraque juste avant l'entrée du Mausolée de RD et parlez lui. Dites lui <span class=\"npc-keyword\">\"fiole de sang de forbin\"</span>. Il vous demandera de lui ramener cette fiole et vous donnera la \"liste\" des items de Drachen qu'l convoite (Sceptre de pouvoir de Drachen, Epée vorpale de Drachen, Plastron de Drachen, Heaume de Drachen, Robe de Drachen) </p><p>Dites lui <span class=\"npc-keyword\">\"Forbin\"</span>. Il va demander une preuve de la confiance de son frère pour continuer la discussion. </p><p>Poursuivez le dialogue et dites lui <span class=\"npc-keyword\">\"preuve\"</span> puis \"récupéré\". Quand il constatera que vous avez la fiole de sang, il sera prêt a vous envoyer vers la forêt de non retour. Dites lui enfin \"envoie\". Vous serez téléportés vers la Forêt de Non-Retour pour trouver les items demandés. </p><p>Une fois tout les items réunis, retournez le voir pour qu'il vous donne une fiole de : <s>puissance/résistance à la magie (+20%).</s> Cette fiole est désormais obsolète. </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 0
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "title": "L'Oracle",
        "description": "<p><b>Attention!</b> si vous êtes séraphin ou néphilim, et si vous voulez affronter Makrsh P'Tangh sur son île ou faire de l'xp aux \"tempos\" dites \"<b>étape finale\" à l'Oracle</b>, il vous enverra sur l'île de Makrsh P'Tangh. </p><p>Par contre, <b>si vous voulez renaître</b>, dites à l'Oracle le mot-clé \"<b>travail</b>\" ... ou directement \"<b>test</b>\". </p><p>En poursuivant le dialogue il vous donnera une clé. </p><p>Dialogue avec l'Oracle : (vous pouvez lui dire directement <b>test</b>) </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Ahhh, enfin nous nous rencontrons. Bienvenue, XXX. Comme vous l'avez sans doute deviné, je suis l'Oracle. </p><p>-- Vous avez dit :<b> travail</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Je suis le Gardien du Temps. Certains ont besoin d'être riche et d'avoir une \"solde\" extraordinaire pour se sentir puissant. En ce qui me concerne, j'ai beaucoup de tâches à accomplir, dont l'une, et non la moindre, est de veiller à l'équilibre entre le Bien et le Mal. Autant vous dire que pour moi la puissance n'est pas la richesse. </p><p>-- Vous avez dit : <b>solde</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Il en est <span class=\"npc-keyword\">\"un\"</span> qui s'estime lui-même hors du flux du temps. Sa présence est une menace pour le délicat équilibre du Bien et du Mal. </p><p>-- Vous avez dit : <b>un</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Je parle de \"Makrsh\" \"P'tang\" bien sûr. Son désir de \"mort\" et de \"destruction\" dépasse l'entendement. </p><p>-- Vous avez dit : <b>makrsh p'tang</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Vous allez devoir vous en occuper, et bientôt, si ce monde veut continuer d'exister. Ils sont peu aujourd'hui à avoir le \"potentiel\" pour affronter quelqu'un d'aussi puissant. Je crois que vous possédez un tel \"potentiel\". </p><p>-- Vous avez dit :<b> potentiel</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Je dis potentiel car je ne pense pas que vous soyez vraiment prêt pour affronter Makrsh P'tang dans l'immédiat. Il y a de nombreuses \"préparations\" à faire avant de pouvoir l'affronter. </p><p>-- Vous avez dit :<b> preparations</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Si vous êtes sur le point d'atteindre votre véritable potentiel, à ce moment là, vous ne ferez plus qu'un avec l'essence séraphique enfouie au plus profond de votre âme. Je dois d'abord vous \"tester\" pour savoir si vous pouvez survivre à la procédure. </p><p>-- Vous avez dit : <b>tester</b> </p><p>--{L'Oracle}<span class=\"npc-keyword\">\":\"</span> Pour votre test, vous allez faire face à Gabriel Archonis (côté good). Vous allez le combattre dans un duel à mort dans une arène spéciale. Il y quatre portes qui entourent le site, chacune d'entre elles vous projettera hors du combat dans un lieu en tranquille. Utiliser une de ces portes signifie que vous déclarez forfait et que vous devrez tout reprendre plus tard. Pour atteindre le lieu du combat, il vous faudra une \"Clef\". </p><p>-- Vous avez dit : <b>clef</b> </p><p><b>L'Oracle vous donne une clef.</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Vous voilà donc... Je crois que vous comprenez ce qui doit être fait maintenant. Soyez rapide et n'ayez pas peur, et vous vaincrez. Rappelez-vous cela quand vous serez dans l'arène. Maintenant allez-y et bonne chance. </p><p><b><br>Dirigez-vous vers l'Assistant au Nord, ouvrez la porte puis parlez à l'Assistant :</b> </p><p><br> -- Votre Clef de jugement déverrouille la porte. </p><p>-- {Assistant de l'Oracle}<span class=\"npc-keyword\">\":\"</span> *Assistant de l'Oracle ...* * Assistant de l'Oracle ...* *Pas très agréable ce travail ...* OH! Bonjour, que puis-je pour vous ? </p><p>-- Vous avez dit : <b>travail</b> </p><p>-- {Assistant de l'Oracle}<span class=\"npc-keyword\">\":\"</span> Encore Vous !! La dernière fois ne vous a pas suffi... encore \"franchir\" le mur je suppose ..? </p><p>-- vous avez dit : <b>franchir</b> </p><p>-- {Assistant de l'Oracle}<span class=\"npc-keyword\">\":\"</span> Hum !!! Bonne chance... </p><p><b>L'Assistant vous téléporte au travers du mur.</b> </p><p>Prenez les escaliers. Vous verrez un portail. Entrez dans l’arène dans laquelle vous trouverez un homme (différent selon le chemin evil ou good). <u>Il y a 4 portails autour de la salle. Surtout ne les touchez PAS</u>, vous seriez téléporté en ville, et il vous faudrait refaire tout le chemin. </p><p>Conformément à ce que l'Oracle vous a dit vous devrez affronter la mort pour finir votre dernier test. Déshabillez-vous (0 CA) ne lancez aucun sort de protection et attaquez le PNJ (Gabriel Archonis côté good ou Gaenen Elthorn côté evil). Vous raterez jusqu'au moment où votre barre de vie sera proche de zéro). A ce moment vous toucherez à chaque fois et tuerez le PNJ. Une fois mort, attendez et vous serez téléporté près de l'Oracle. </p><p>Parlez-lui une dernière fois... </p><p>-- vous avez dit : <b>prêt a renaitre</b> </p><p>-- {L'Oracle}<span class=\"npc-keyword\">\":\"</span> Etes vous absolument certain de vouloir renaître maintenant ? </p><p>-- vous avez dit : <b>oui</b> </p><p>et... </p><p><b>L'Oracle: Félicitations à xxxxxx</b> pour sa 1ère (ou autre)... renaissance!<b> </b><b></b> </p>",
        "images": [],
        "order": 8
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p>Cette quête vous permettra de renaître en Déchu. Vous devez étre x5 et level 100. </p><p>Pour commencer vous pouvez préparer les accès nécessaires suivants pour pouvoir parler au différents PNJ impliqués dans cette quête. </p><ul><li>Iles Ethérées</li> <li>Zone Oracle Good ou Evil</li> <li>Dragon Island</li></ul><p>Pour commencer, rendez-vous au château de Silversky pour parler au PNJ Cuisteau. Il vous envoie à Niève (dans la première grotte, celle qui lies le mausolé au village Nieve) parler à Tafnoir Aigridor (dites lui travail). Celui ci vous demande de récupérer 30 peaux de loups (les loups blancs de la plaine de Niève). Une fois ces peaux obtenues, retournez le voir. Il vous envoie voir le tanneur Ladre Citre, se trouvant dans le village de Niève (vers le Sud en-dessous de la maison de l'ogresse) auquel vous donnerez ces peaux. Dites lui <span class=\"npc-keyword\">\"travail\"</span> \"débordé\" \"oui\". </p><p>Celui-ci vous donne des pièces d'or ainsi qu'une clef permettant d'ouvrir une maison un peu plus haut (Maison de l'Ogresse). Vous y trouverez un coffre (forme de chaudron) dans lequel vous devez récupérer deux cuisseaux en cliquant dessus. </p><p><br> </p><p>Rendez-vous ensuite dans la maison de Malcolm Fello <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1720,490,4)</span> se trouvant dans une maison après la caverne des gobelins des glaces bleus (nord est de la sortie de la grotte). Dites lui <span class=\"npc-keyword\">\"odeur\"</span> \"oui\" etc. Celui ci vous dit que son frère jumeau Maclom Fello <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(1930,315,4)</span> sera plus à même de vous aider. Rendez-vous donc vers le Nord dans la maison du frère. Il vous demandera 50 baves de Zart mais il ne les prendra pas, vous pourrez donc les réutiliser pour la suite. Allez ensuite à Stonecrest voir Joignus Judas. Il se trouve au Sud Ouest du temple de SC, près de l'enclos à chevaux. Dites lui <span class=\"npc-keyword\">\"travail\"</span>. </p><p><b>Il vous demandera de lui trouver :</b> </p><ul><li>2 calices d'or (droppés sur RD par le Disciples de l'Ombre)</li> <li>10 piles d'arbres démoniaques (droppées par les Arbres Démoniaques)</li> <li>5 graals de pureté (droppés par les Vengeurs Centaures).</li></ul><p>Une fois les objets récupérés, Joignus vous demande d'aller voir Malorus <span class=\"coords-trigger cursor-pointer bg-slate-700/50 px-1.5 py-0.5 rounded text-cyan-400 border border-slate-600 hover:bg-cyan-500/20 transition-colors\" title=\"Cliquer pour copier\">(972,1469,3)</span> situé au sud est de DI. (Sortez au pont nord, puis ensuite marchez vers l'est jusqu'à l'eau, vous tomberez sur sa maison) Il vous demande d'aller chercher le crâne de Liridell. Une fois le crâne obtenu, retournez le voir et dites lui <span class=\"npc-keyword\">\"Yioko\"</span>. Il vous donnera alors le bol d'Amnet. Puis rendez-vous à Silversky pour parler à nouveau à Cuisteau. </p><p><b>Vous devrez lui rapporter :</b> </p><ul><li>10 yeux de tarentules</li> <li>50 baves de Zartgax</li> <li>5 fioles de sang de gobelin</li> <li>Tous les artefacts des dragons (Arakas 2, Raven's Dust 2, Niève 1, Stoneheim 2, Drake Island 1)</li></ul><p><br> </p><p>Il vous demandera, une fois ces items rapportés, d'aller trouver l'assistant de l'Oracle (il vous faut donc votre accès Zone Oracle) </p><p><b>Celui-ci vous réclamera, contre la Cuillère d'Amnet :</b> </p><ul><li>Une Cuillère du prophète (vous la trouverez à l'asile)</li> <li>2 fioles de liquide bleuté (drop minotaures RD)</li></ul><p><br> </p><p>Retournez voir le Cuisteau et il vous dira d'aller voir Amnet. Il se trouve à Niève, à l'ouest du temple. Préparez pas mal de potions critiques, la suite est assez difficile. Dites lui <span class=\"npc-keyword\">\"soupe\"</span> et il vous téléportera dans une cave. Dites Ashardalonn, puis coeur à Isen le Sage. Et prenez le chemin du bas, longez les murs, c'est plus facile. Vous arriverez alors dans un énorme cercle vert où se trouvent plein d'Ent Enragés et un seul \"Ent Faiblard\". </p><p>Tuez le, et vous serez téléportez à côté d'Amnet, vous n'avez plus qu'à vous soumettre à lui. </p><p><b>Conseils :</b> </p><ul><li>Utilisez le sort sanctuaire afin de vous déplacer jusqu'au cercle vert sans être enchevêtré.</li> <li>Une fois arrivé, popotez le temps de pouvoir ré-attaquer. A ce moment vous serrez entourés d'Ent enragés qui sont immortels, mais l'Ent faiblard sera dans le tas.</li> <li>Le meilleur moyen est de lancer des sorts a effets de zone (il n'est pas très fort).</li></ul><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [],
        "order": 1
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<ul><li>Vous devez avoir accès à l'Académie niveau -1.</li> <li>Trouvez un coffre dans une des zones pour niveau 175+ (il y en a un dans chaque zone), vous devez le camper jusqu'à obtenir un \"Parchemin des ténèbres\" (vous avez le temps entre les niveaux 175 et 200).</li> <li>Quand vous utiliserez le parchemin (vers le level 200), il fera apparaître le \"Chevalier Ténébreux\" dans la zone ou vous êtes. Faites vous aider.</li> <li><b>Avec l'aide d'un petit groupe solide</b>, attaquez-le (collez-le bien et faites le ménage d'abord). Quand vous l'aurez tué il réapparaîtra automatiquement dans les autres zones. Vous devrez le tuer dans les 4 zones (un seul parchemin suffit).</li> <li>Lorsque vous tuez le Chevalier ténébreux un message apparaît : \"Le chevalier ténébreux s'empare de votre Ame...\". Vous devez voir ce message dans chaque zone pour que la quête soit complète. S'il n'apparaît pas dans une zone, tuez à nouveau le Chevalier dans la zone concernée suffira, même si c'est avec un autre groupe.</li> <li>Une fois le Chevalier Ténébreux tué dans les 4 zones, rendez vous au milieu de l'Académie et cliquez sur le Puits. <ul><li>\"Le puits absorbe les ténèbres de votre âme.....\"</li></ul></li> <li>Vous avez désormais accès au 2ème niveau de l'Académie, les escaliers pour y descendre se trouvent au bout de chaque salle d'XP des zones 175+. Vous devez être niveau 200 pour franchir la porte.</li></ul><ul><li>\"Le puits absorbe les ténèbres de votre âme.....\"</li></ul><p>N.B 1 : Vous pouvez réaliser la quête en groupe, tous les membres du groupe participants aux combats contre le Chevalier Ténébreux auront accès à L'Académie niveau -2. </p><p>N.B.2 : Pour les soigneurs du groupe : Vous devez obligatoirement frapper au moins une fois le Chevalier dans chaque zone pour que la quête vous soit validée. </p><p>N.B.3 : Les Chevaliers disparaissent au bout d'une heure s'il ne sont pas tués. </p>",
        "images": [],
        "order": 1
      },
      {
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "Quête des ornements",
        "description": "<p>Vous devez être niveau 200+ pour pouvoir vous rendre Académie -2. </p><p>Prenez sur vous un ou plusieurs lots de 50 minerais de : </p><ul><li>rubis</li> <li>émeraude</li> <li>diamant</li> <li>saphir</li> <li>titane pour lingot de titane (qui n'est pas cité)</li></ul><p>Rendez vous chez<b> Retally</b>, dans une maison aux Yétis de la serre, à l'Académie-2. </p><p>Parlez-lui : mots clés \"minerais\" \"ornements\" \"pierres\" et le nom des minerais que vous voulez transformer. </p><p>Retally transformera votre lot de 50 minerais en un ornement et vous donnera 2,5M xp/level selon votre level. </p><p>Par exemple au level 200, un ornement vous rapportera 500M. Intéressant pour \"petits\" levels. </p><p> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> <big></big> </p>",
        "images": [
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "<p class=\"Style3\" align=\"center\">.</p>",
        "images": [
      ...
      },
      {
        ...
        "description": "<p>Et là beaucoup beaucoup de marche... </p><p><b>Attention !</b> Vous devez être immunisé contre la téléportation (potion d'inertie d'Evalcian) pour traverser la salle du coffre clé de chair 10. </p><p>Ici aussi vous devez parcourir les îles obsidiennes. Cette fois-ci pour obtenir les clefs en obsidienne #19, #11, #8 et #4. Faites d'abord toutes les clés jusqu'à la clé 19 puis recommencez jusqu'à la 11, de même pour la 8 et pour la 4. Vous allez marcher beaucoup et c'est pas fini.... </p><p>Vous devez aussi vous procurer (avec un peu de chance ces clefs traînent dans votre coffre ou un GB vous les donnera) : </p><p>- Une clef tordue &gt; drop des Seigneurs ténébreux de la guerre (cave du Château de Mordenthal au Nord de SH) </p><p>- Une clef de pierre &gt; drop de divers morts-vivants de RD </p><p>- Une clef de fer noircie &gt; drop de divers monstres de la crypte de Lord Stonecrest sur SH </p><p>- Une clef d'os poli &gt; drop de divers monstres de la crypte Centaures à l'Est de la ville Centaure sur SH (Ennemi des Ombres.....) </p><p><br>Ensuite allez dans la salle aux dix dalles bleues (NO de la salle où on obtient la clef de chair durcie #10). </p><p>Activez les dalles de 1 à 2 dans cette salle, puis prenez le tourbillon du milieu dans la salle aux quatre tourbillons (ouverte par la clef de chair durcie #11) pour trouver la clef rouillée du donjon #7 dans le petit coffre tout à gauche de la petite île ou vous arrivez. Puis recall ... </p><p style=\"text-align:right;\"></p><p class=\"mw-empty-elt\"></p><p style=\"text-align:right;\"></p><p>Activez les dalles 1 à 4 et cliquez sur l'autre petit coffre à gauche de l'île pour avoir la clef rouillée du donjon #8. Puis recall... </p><p>Activez maintenant les dalles 1 à 6 pour cliquer sur le petit coffre centre droit de l'île pour obtenir la clef rouillée du donjon #9. Puis recall ... </p><p><br>Puis activez les dalles de 1 à 8 et ouvrez le petit coffre le plus à droite de l'île pour obtenir la clef rouillée du donjon #10. Puis recall... </p><p><br>Enfin, retournez activer les dalles de 1 à 10 et trouvez la clef de chair durcie #14 dans le coffre au <u>centre de la salle aux dalles bleues.</u> </p>",
        "images": [
      ...
      },
      {
        ...
        "description": "<p>Maintenant c'est du gâteau !! </p><p>Sans la fiole de protection contre la terreur, cette clé est la plus difficile à cause de la perte de contrôle due aux gargouilles (cette fiole n'existe que depuis peu et la clé était jadis une vraie galère mais qui a laissé aux anciens des souvenirs inoubliables) . </p><p>Il s'agit d'obtenir dans l'ordre les clefs corail 2 4 5 6 et 7 avant de s'attaquer à la clef de chair #17 proprement dite. </p><p>Tip: : Il existe maintenant une fiole de protection contre la terreur (craft) qui permet de supprimer l'effet des gargouilles et facilite grandement l'obtention de cette clé. Une fiole est active durant 30 minutes. </p><ul><li>Clef corail #2</li></ul><p><b>Salle des gargouilles pour les clés corail suivantes :</b> </p><p>Rendez vous salle des gargouilles et explorez les vortex dans l'ordre, chaque clef corail ouvre le coffre qui donne sa suite numérique (Clef #4 ouvre le coffre pour trouver la #5... Clef #5 ouvre le coffre pour trouver la #6... etc).<b> </b> </p><p>N<b>oter que les clefs corail sont à usage unique !</b> </p><p><br> </p><ul><li>Clef corail #4 </li></ul><p>Tourbillon N°1 (au nord) afin d'obtenir la clef corail #4. </p><p>Recall après avoir eu votre clef. </p><p><br> </p><ul><li>Clef corail #5</li></ul><p>Tourbillon N°2 (à l'est) afin d'obtenir la clef corail #5. </p><p>Recall après avoir eu votre clef. </p><p><br> </p><ul><li>Clef corail #6</li></ul><p>Tourbillon N°3 (à l'ouest) afin d'obtenir la clef corail #6. </p><p>Recall après avoir eu votre clef. </p><p><br> </p><ul><li>Clef corail #7 </li></ul><p>Tourbillon N°4 (caché au sud) afin d'obtenir la clef corail #7. </p><p>Recall après avoir eu votre clef. </p><p><br> </p><ul><li>Clef de chair #17</li></ul><p>Le repop des 4 premiers coffres est de 20 minutes (seul)... immédiat à plusieurs... </p><p>Le coffre qui drop la clef #17 n'a pas de temps de repop. </p><p>Légende : </p><p>- Etoile verte = Point de départ </p><p>- Point jaune = Tourbillon qui vous téléporte au début </p><p><br> </p>",
        "images": [
